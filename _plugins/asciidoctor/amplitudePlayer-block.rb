...
# Usage:
#
#   amplitudePlayer::player_id[role="additional classes"]
#
# Example:
#
#   .Player title
#   amplitudePlayer::example_player[role="mt-3 mb-5"]
#
# ------------------------------------------------------------------------------
Asciidoctor::Extensions.register do

  class AmplitudePlayerBlockMacro < Extensions::BlockMacroProcessor
    use_dsl

    named :amplitudePlayer
  ...
  block_macro AmplitudePlayerBlockMacro
end
