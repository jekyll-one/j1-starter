...
(function (root, factory) {
  ...
  // (_convertVideoPlayerPlaylist) drops such entries so player.src() never
  ...
  class PlaylistManager {
    ...
    // -------------------------------------------------------------------------
    _convertVideoPlayerPlaylist(rawPlaylist) {
      ...
      onReady: (player) => {
        ...
        if (videoPlayerOptions.videoJS.autoStart) {
          ...
          if (piPlaylist.enabled) {
            ...
            // mapVideoPlayerPlaylist + _convertVideoPlayerPlaylist().
            //
            ...
            // get current item
            let currentIndex = vjsPlayer.playlist.currentItem();

            // claude - Modify J1 VideoPlayer #19
            // Guard the (demo) currentItem() jump so a short or empty
            // converted playlist can never produce an out-of-range index
            if (playlist.length > 0) {
