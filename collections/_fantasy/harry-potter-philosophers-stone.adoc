...
image:
  path:                                 /assets/image/collections/books/fantasy/harry-potter-philosophers-stone.jpg

book:
  cover:                                /assets/image/collections/books/fantasy/harry-potter-philosophers-stone.jpg
  format:                               hardback
  pages:                                640
