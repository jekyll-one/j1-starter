...
image:
  path:                                 /assets/image/modules/attics/machine-generator-1920x1280.jpg
  width:                                1920
  height:                               1280
  alt:                                  Site Generators
...
resource_options:
  - attic:
      padding_top:                      630
      slides:
        - url:                          /assets/image/modules/attics/machine-generator-1920x1280.jpg
...
image::/assets/image/posts/featured/jamstack-generators.jpg["SSGs at Jamstack"]
