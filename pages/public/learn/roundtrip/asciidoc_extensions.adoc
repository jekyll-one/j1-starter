...
[source, no_template, role="noclip"]
----
iconify:logos:opensource[2x, ml-4 mr-2 mb-2] Brand icon Open Source  +
...
[.result]
====
iconify:logos:opensource[2x, ml-4 mb-2] Brand icon Open Source  +
...
Asciidoc extensions open up more possibilities. The number of extensions
available will grow. Extensions gives handy and powerful functionality
needed for modern web pages based on the Asciidoc Markup language generated
by Jekyll and J1 Template.
