...
J1 Template offers unique functionalities compared to other Jekyll templates.
Themes for the J1 Template are based on the free and Open Source CSS front-end
framework Bootstrap of version V5. Bootstrap themes for the J1 enable the
presentation of different skins of the same site using already prepared
CSS templates.
